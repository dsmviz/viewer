...
namespace Dsmviz.Viewer.View.Matrix
{
    public class MatrixFrameworkElement : FrameworkElement
    {
        ...
        private static readonly List<ushort> MGlyphIndexesList = [];
        private static readonly List<double> MAdvanceWidthsList = [];

        private struct GlyphInfo(ushort glyphIndex, double width)
        {
